...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        default=['RandomFlip', 'AutoAugment', 'DefaultFormatBundle', 'Normalize', 'Collect', 'Pad'],
...
def main():
    ...
    for i, item in enumerate(dataset):
        ...
        imshow_det_interactions(
            item['img'],
            item['gt_sub_bboxes'],
            item['gt_obj_bboxes'],
            item['gt_obj_labels'],
            item['gt_verb_labels'],
            obj_names=dataset.OBJ_CLASSES,
            verb_names=dataset.VERB_CLASSES,
