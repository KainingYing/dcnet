...
from mmhoidet.apis import multi_gpu_test, single_gpu_test
...
def main():
    ...
    if 'OBJ_CLASSES' in checkpoint.get('meta', {}) and 'VERB_CLASSES' in checkpoint.get('meta', {}):
        ...
        model.OBJ_CLASSES = dataset.OBJ_CLASSES
        model.VERB_CLASSES = dataset.VERB_CLASSES
        model.valid_hois = dataset.valid_hois
