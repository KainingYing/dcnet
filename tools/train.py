...
from mmhoidet import __version__
from mmhoidet.apis import set_random_seed, train_detector
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train a hoi detector')
