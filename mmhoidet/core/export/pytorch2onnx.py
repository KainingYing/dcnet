...
def generate_inputs_and_wrap_model(config_path,
    ...
    For example, the mmhoidet models' forward function has a parameter
    ...
    Args:
        ...
        input_config (dict): the exactly data in this dict depends on the
            ...
            and generate the dummy data accordingly. However, for mmhoidet,
...
def build_model_from_cfg(config_path, checkpoint_path, cfg_options=None):
    ...
    if 'CLASSES' in checkpoint.get('meta', {}):
        ...
        from mmhoidet.datasets import DATASETS
...
def preprocess_example_input(input_config):
    ...
    Examples:
        >>> from mmhoidet.core.export import preprocess_example_input
        >>> input_config = {
